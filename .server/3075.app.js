...
const data = {
  ...
  "filePathRelative": "6.x/official-account/index.md",
  "git": {
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[1]!./node_modules/@vuepress/bundler-webpack/lib/build/ssr/vuepressLoader.js!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./.vuepress/.temp/pages/6.x/official-account/index.html.vue?vue&type=template&id=6a65f0dc
...
function ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<!--[--><h1 id="公众号" tabindex="-1"><a class="header-anchor" href="#公众号" aria-hidden="true">#</a> 公众号</h1><blockquote><p>🚨 使用前建议熟读 <a href="https://developers.weixin.qq.com/doc/offiaccount/Getting_Started/Overview.html" target="_blank" rel="noopener noreferrer">微信官方文档: 公众号`)
...
<span class="token variable">\$app</span> <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Application</span><span class="token punctuation">(</span><span class="token variable">\$config</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  ...
  _push((0,server_renderer_.ssrRenderComponent)(_component_RouterLink, { to: "/6.x/official-account/config.html" }, {
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h3 id="网页授权" tabindex="-1"><a class="header-anchor" href="#网页授权" aria-hidden="true">#</a> 网页授权</h3><div class="language-php ext-php line-numbers-mode"><pre class="language-php"><code><span class="token variable">\$oauth</span> <span class="token operator">=</span> <span class="token variable">\$app</span><span class="token operator">-&gt;</span><span class="token function">getOAuth</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
;// CONCATENATED MODULE: ./.vuepress/.temp/pages/6.x/official-account/index.html.vue?vue&type=template&id=6a65f0dc

;// CONCATENATED MODULE: ./.vuepress/.temp/pages/6.x/official-account/index.html.vue

const script = {}
;
script.ssrRender = (...args) => {
  const ssrContext = args[2].appContext.provides[external_vue_.ssrContextKey]
  ssrContext._registeredComponents.add("/home/runner/work/easywechat/easywechat/docs/node_modules/@vuepress/bundler-webpack/lib/build/ssr/vuepressLoader.js!/home/runner/work/easywechat/easywechat/docs/node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!/home/runner/work/easywechat/easywechat/docs/.vuepress/.temp/pages/6.x/official-account/index.html.vue")
...
;
//# sourceMappingURL=3075.app.js.map