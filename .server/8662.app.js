...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[1]!./node_modules/@vuepress/bundler-webpack/lib/build/ssr/vuepressLoader.js!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./.vuepress/.temp/pages/3.x/tutorial.html.vue?vue&type=template&id=7c4d3325
...
function ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<!--[--><h1 id="快速开始" tabindex="-1"><a class="header-anchor" href="#快速开始" aria-hidden="true">#</a> 快速开始</h1><p>在我们已经安装完成后，即可很快的开始使用它了，当然你还是有必要明白PHP基本知识，如命名空间等，我这里就不赘述了。</p><p>我们以完成服务器端验证与接收响应用户发送的消息为例来演示,首先你有必要了解一下微信交互的运行流程：</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>                                     +-----------------+                       +---------------+
    +----------+                     |                 |    POST/GET/PUT       |               |
    |          | ------------------&gt; |                 | -------------------&gt;  |               |
...
</span></code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br></div></div><blockquote><p>❤️ 安全模式下请一定要填写 <code>aes_key</code></p></blockquote><p>一个服务端带验证功能的代码已经完成，当然没有对消息做处理，别着急，后面我们再讲。</p><p>我们先来分析上面的代码：</p><div class="language-php ext-php line-numbers-mode"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
...
<span class="token comment">// 将响应输出</span>
<span class="token variable">\$response</span><span class="token operator">-&gt;</span><span class="token function">send</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span> <span class="token comment">// Laravel 里请使用：return \$response;</span>
</span></code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><p>最后这一行我有必要详细讲一下：</p><blockquote><ol><li>我们的 <code>\$app-&gt;server-&gt;serve()</code> 就是执行服务端业务了，那么它的返回值呢，是一个 <code>Symfony\\Component\\HttpFoundation\\Response</code> 实例。</li><li>我这里是直接调用了它的 <code>send()</code> 方法，它就是直接输出了，我们在一些框架就不能直接输出了，那你就直接拿到 Response 实例后做相应的操作即可，比如 Laravel 里你就可以直接 <code>return \$app-&gt;server-&gt;serve();</code></li></ol></blockquote><p>OK, 有了上面的代码，那么请你按 <strong><a href="http://mp.weixin.qq.com/wiki/17/2d4265491f12608cd170a95559800f2d.html" target="_blank" rel="noopener noreferrer">微信官方的接入指引`)
  _push((0,server_renderer_.ssrRenderComponent)(_component_OutboundLink, null, null, _parent))
  _push(`</a></strong> 操作，并相应修改上面的 <code>\$options</code> 的配置。</p><blockquote><p>URL 就是我们的 <code>http://easywechat.org/server.php</code>，这里我是举例哦，你可不要填写我的域名。</p></blockquote><p>这样，点击提交验证就OK了。</p><blockquote><p>❤️ 请一定要将微信后台的开发者模式 “<strong>启用</strong>” ！！！！！！看到红色 “<strong>停用</strong>” 才真正的是启用了。</p></blockquote><h2 id="接收-回复用户消息" tabindex="-1"><a class="header-anchor" href="#接收-回复用户消息" aria-hidden="true">#</a> 接收 &amp; 回复用户消息</h2><p>那服务端验证通过了，我们就来试一下接收消息吧。</p><blockquote><p>在刚刚上面代码最后一行 <code>\$app-&gt;server-&gt;serve()-&gt;send();</code> 前面，我们调用 <code>\$app-&gt;server</code> 的 <code>setMessageHandler()</code> 方法来注册一个消息处理函数，这里用到了 <strong><a href="http://php.net/manual/zh/functions.anonymous.php" target="_blank" rel="noopener noreferrer">PHP 闭包`)
  _push((0,server_renderer_.ssrRenderComponent)(_component_OutboundLink, null, null, _parent))
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><blockquote><p>注意：send() 方法里已经包含 echo 了，请不要再加 echo 在前面。</p></blockquote><p>好吧，打开你的微信客户端，向你的公众号发送任意一条消息，你应该会收到回复：<code>您好！欢迎关注我!</code>。</p><blockquote><p>没有收到回复？看到了“你的公众号暂时无法提供服务” ？， 好，那检查一下你的日志吧，日志在哪儿？我们的配置里写了日志路径了(<code>&#39;/tmp/easywechat.log&#39;</code>)。 没有这个文件？看看权限哦。</p></blockquote><p>一个基本的服务端验证就完成了。</p><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2><ol><li>所有的服务都通过主入口 <code>EasyWeChat\\Foundation\\Application</code> 类来获取：</li></ol><div class="language-php ext-php line-numbers-mode"><pre class="language-php"><code><span class="token variable">\$app</span> <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Application</span><span class="token punctuation">(</span><span class="token variable">\$options</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><ol start="2"><li>所有的 API 返回值均为 <a href="https://github.com/EasyWeChat/support/blob/master/src/Collection.php" target="_blank" rel="noopener noreferrer"><code>EasyWeChat\\Support\\Collection</code>`)
  _push((0,server_renderer_.ssrRenderComponent)(_component_OutboundLink, null, null, _parent))
  _push(`</a> 类，这个类是个什么东西呢？</li></ol><p>它实现了一些 <strong><a href="http://php.net/manual/zh/reserved.interfaces.php" target="_blank" rel="noopener noreferrer">PHP预定义接口`)
  _push((0,server_renderer_.ssrRenderComponent)(_component_OutboundLink, null, null, _parent))
  _push(`</a></strong>，比如：<a href="http://php.net/manual/zh/class.arrayaccess.php" target="_blank" rel="noopener noreferrer"><code>ArrayAccess</code>`)
  _push((0,server_renderer_.ssrRenderComponent)(_component_OutboundLink, null, null, _parent))
  _push(`</a>、<a href="http://php.net/manual/zh/class.serializable.php" target="_blank" rel="noopener noreferrer"><code>Serializable</code>`)
  _push((0,server_renderer_.ssrRenderComponent)(_component_OutboundLink, null, null, _parent))
  _push(`</a> 等。</p><p>有啥好处呢？它让我们操作起返回值来更方便，比如：</p><div class="language-php ext-php line-numbers-mode"><pre class="language-php"><code><span class="token variable">\$userService</span> <span class="token operator">=</span> <span class="token variable">\$app</span><span class="token operator">-&gt;</span><span class="token property">user</span><span class="token punctuation">;</span> <span class="token comment">// 用户API</span>
...
<span class="token comment">//...</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><p>还有这些方便的操作：检查是否存在某个属性 <code>\$user-&gt;has(&#39;email&#39;)</code>、元素个数 <code>\$user-&gt;count()</code>，还有返回数组 <code>\$user-&gt;toArray()</code> ，生成 JSON <code>\$user-&gt;toJSON()</code> 等。</p><h2 id="最后" tabindex="-1"><a class="header-anchor" href="#最后" aria-hidden="true">#</a> 最后</h2><p>希望你在使用本 SDK 的时候能忘记微信官方给你的痛苦，同时如果你发现 SDK 的不足，欢迎提交 PR 或者给我<a href="https://github.com/overtrue/wechat/issues" target="_blank" rel="noopener noreferrer">提建议 &amp; 报告问题`)
  _push((0,server_renderer_.ssrRenderComponent)(_component_OutboundLink, null, null, _parent))
  _push(`</a>。</p><p>祝你生活愉快！</p><!--]-->`)
}
;// CONCATENATED MODULE: ./.vuepress/.temp/pages/3.x/tutorial.html.vue?vue&type=template&id=7c4d3325

;// CONCATENATED MODULE: ./.vuepress/.temp/pages/3.x/tutorial.html.vue
...
;
//# sourceMappingURL=8662.app.js.map